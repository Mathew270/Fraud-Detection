# SSE Stream: Service Documentation
...
flowchart LR
    ...
    AlertSink[alertSink]
    SSETx["GET /api/sse/transactions"]
    SSEAlerts["GET /api/sse/alerts"]
...
| :--- | :--- | :--- | :--- |
| `/api/sse/transactions` | `GET` | `text/event-stream` | Continuous stream of all financial transactions |
| `/api/sse/alerts` | `GET` | `text/event-stream` | Continuous stream of fraud alert events |

**How SSE Works:**
When a browser opens a connection to `/api/sse/transactions`, Spring WebFlux:
...
- `http://localhost:8085/api/sse/transactions`
- `http://localhost:8085/api/sse/alerts`
